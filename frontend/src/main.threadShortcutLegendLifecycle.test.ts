...
describe('thread shortcut legend lifecycle presentation (main integration)', () => {
  ...
  it('keeps shown Esc alias with shiftKey=true as no-op for editable target when event is defaultPrevented or repeat', () => {
    const ignoredShownEditableDefaultPreventedEscAliasShiftDispatch =
      getThreadShortcutLegendKeyboardDispatchOutcome({
        isVisible: true,
        key: 'Esc',
        shiftKey: true,
    ...
    expect(ignoredShownEditableDefaultPreventedEscAliasShiftDispatch).toEqual({
      handled: false,
      nextVisibility: true,
      statusHint: null,
    })

    const ignoredShownEditableRepeatEscAliasShiftDispatch =
      getThreadShortcutLegendKeyboardDispatchOutcome({
        isVisible: true,
        key: 'Esc',
        shiftKey: true,
    ...
    expect(ignoredShownEditableRepeatEscAliasShiftDispatch).toEqual({
      handled: false,
      nextVisibility: true,
      statusHint: null,
    })

    const ignoredShownEditableDefaultPreventedEscAliasShiftRenderState =
      getThreadShortcutLegendKeyboardRenderState({
        isVisible: true,
        key: 'Esc',
        shiftKey: true,
    ...
    expect(ignoredShownEditableDefaultPreventedEscAliasShiftRenderState.handled).toBe(false)
    expect(ignoredShownEditableDefaultPreventedEscAliasShiftRenderState.nextVisibility).toBe(true)
    expect(ignoredShownEditableDefaultPreventedEscAliasShiftRenderState.statusHint).toBeNull()
    expect(ignoredShownEditableDefaultPreventedEscAliasShiftRenderState.statusAriaLabel ?? null).toBeNull()

    const ignoredShownEditableRepeatEscAliasShiftRenderState =
      getThreadShortcutLegendKeyboardRenderState({
        isVisible: true,
        key: 'Esc',
        shiftKey: true,
    ...
    expect(ignoredShownEditableRepeatEscAliasShiftRenderState.handled).toBe(false)
    expect(ignoredShownEditableRepeatEscAliasShiftRenderState.nextVisibility).toBe(true)
    expect(ignoredShownEditableRepeatEscAliasShiftRenderState.statusHint).toBeNull()
    expect(ignoredShownEditableRepeatEscAliasShiftRenderState.statusAriaLabel ?? null).toBeNull()

    const shownNoOpPresentation = getThreadShortcutLegendPresentation(
      ignoredShownEditableRepeatEscAliasShiftRenderState.nextVisibility,
    )
    expect(shownNoOpPresentation.ariaExpanded).toBe(
      ignoredShownEditableRepeatEscAliasShiftRenderState.nextVisibility,
    )
  ...
  it('keeps shown Escape/Esc editable-target modifier-key paths as no-op dispatch outcomes', () => {
    ...
    expect(ignoredShownEditableMetaEscapeDispatch).toEqual({
      handled: false,
      nextVisibility: true,
      statusHint: null,
    })

    const ignoredShownEditableCtrlEscapeDispatch = getThreadShortcutLegendKeyboardDispatchOutcome({
      isVisible: true,
      key: 'Escape',
      shiftKey: false,
      metaKey: false,
    ...
    expect(ignoredShownEditableCtrlEscapeDispatch).toEqual({
      handled: false,
      nextVisibility: true,
      statusHint: null,
    })

    const ignoredShownEditableAltEscapeDispatch = getThreadShortcutLegendKeyboardDispatchOutcome({
      isVisible: true,
      key: 'Escape',
      shiftKey: false,
      metaKey: false,
    ...
    expect(ignoredShownEditableAltEscapeDispatch).toEqual({
      handled: false,
      nextVisibility: true,
      statusHint: null,
    })

    const ignoredShownEditableMetaEscAliasDispatch = getThreadShortcutLegendKeyboardDispatchOutcome({
      isVisible: true,
      key: 'Esc',
      shiftKey: false,
      metaKey: true,
    ...
    expect(ignoredShownEditableMetaEscAliasDispatch).toEqual({
      handled: false,
      nextVisibility: true,
      statusHint: null,
    })

    const ignoredShownEditableCtrlEscAliasDispatch = getThreadShortcutLegendKeyboardDispatchOutcome({
      isVisible: true,
      key: 'Esc',
      shiftKey: false,
      metaKey: false,
    ...
    expect(ignoredShownEditableCtrlEscAliasDispatch).toEqual({
      handled: false,
      nextVisibility: true,
      statusHint: null,
    })

    const ignoredShownEditableAltEscAliasDispatch = getThreadShortcutLegendKeyboardDispatchOutcome({
      isVisible: true,
      key: 'Esc',
      shiftKey: false,
      metaKey: false,
    ...
    expect(ignoredShownEditableAltEscAliasDispatch).toEqual({
      handled: false,
      nextVisibility: true,
      statusHint: null,
    })
  ...
  it('keeps shown Escape with shiftKey=true editable-target modifier-key paths as no-op dispatch/render-state outcomes', () => {
    const ignoredShownEditableMetaEscapeShiftDispatch =
      getThreadShortcutLegendKeyboardDispatchOutcome({
        isVisible: true,
        key: 'Escape',
        shiftKey: true,
    ...
    expect(ignoredShownEditableMetaEscapeShiftDispatch).toEqual({
      handled: false,
      nextVisibility: true,
      statusHint: null,
    })

    const ignoredShownEditableCtrlEscapeShiftDispatch =
      getThreadShortcutLegendKeyboardDispatchOutcome({
        isVisible: true,
        key: 'Escape',
        shiftKey: true,
    ...
    expect(ignoredShownEditableCtrlEscapeShiftDispatch).toEqual({
      handled: false,
      nextVisibility: true,
      statusHint: null,
    })

    const ignoredShownEditableAltEscapeShiftDispatch =
      getThreadShortcutLegendKeyboardDispatchOutcome({
        isVisible: true,
        key: 'Escape',
        shiftKey: true,
    ...
    expect(ignoredShownEditableAltEscapeShiftDispatch).toEqual({
      handled: false,
      nextVisibility: true,
      statusHint: null,
    })

    const ignoredShownEditableMetaEscapeShiftRenderState =
      getThreadShortcutLegendKeyboardRenderState({
        isVisible: true,
        key: 'Escape',
        shiftKey: true,
    ...
    expect(ignoredShownEditableMetaEscapeShiftRenderState.handled).toBe(false)
    expect(ignoredShownEditableMetaEscapeShiftRenderState.nextVisibility).toBe(true)
    expect(ignoredShownEditableMetaEscapeShiftRenderState.statusHint).toBeNull()
    expect(ignoredShownEditableMetaEscapeShiftRenderState.statusAriaLabel ?? null).toBeNull()

    const ignoredShownEditableCtrlEscapeShiftRenderState =
      getThreadShortcutLegendKeyboardRenderState({
        isVisible: true,
        key: 'Escape',
        shiftKey: true,
    ...
    expect(ignoredShownEditableCtrlEscapeShiftRenderState.handled).toBe(false)
    expect(ignoredShownEditableCtrlEscapeShiftRenderState.nextVisibility).toBe(true)
    expect(ignoredShownEditableCtrlEscapeShiftRenderState.statusHint).toBeNull()
    expect(ignoredShownEditableCtrlEscapeShiftRenderState.statusAriaLabel ?? null).toBeNull()

    const ignoredShownEditableAltEscapeShiftRenderState =
      getThreadShortcutLegendKeyboardRenderState({
        isVisible: true,
        key: 'Escape',
        shiftKey: true,
    ...
    expect(ignoredShownEditableAltEscapeShiftRenderState.handled).toBe(false)
    expect(ignoredShownEditableAltEscapeShiftRenderState.nextVisibility).toBe(true)
    expect(ignoredShownEditableAltEscapeShiftRenderState.statusHint).toBeNull()
    expect(ignoredShownEditableAltEscapeShiftRenderState.statusAriaLabel ?? null).toBeNull()

    const shownNoOpPresentation = getThreadShortcutLegendPresentation(
      ignoredShownEditableAltEscapeShiftRenderState.nextVisibility,
    )
    expect(shownNoOpPresentation.ariaExpanded).toBe(
      ignoredShownEditableAltEscapeShiftRenderState.nextVisibility,
    )
  ...
  it('keeps shown Escape with shiftKey=true editable-target modifier+event-gate paths as no-op dispatch/render-state outcomes', () => {
    const ignoredShownEditableMetaDefaultPreventedEscapeShiftDispatch =
      getThreadShortcutLegendKeyboardDispatchOutcome({
        isVisible: true,
        key: 'Escape',
        shiftKey: true,
    ...
    expect(ignoredShownEditableMetaDefaultPreventedEscapeShiftDispatch).toEqual({
      handled: false,
      nextVisibility: true,
      statusHint: null,
    })

    const ignoredShownEditableCtrlRepeatEscapeShiftDispatch =
      getThreadShortcutLegendKeyboardDispatchOutcome({
        isVisible: true,
        key: 'Escape',
        shiftKey: true,
    ...
    expect(ignoredShownEditableCtrlRepeatEscapeShiftDispatch).toEqual({
      handled: false,
      nextVisibility: true,
      statusHint: null,
    })

    const ignoredShownEditableAltDefaultPreventedEscapeShiftRenderState =
      getThreadShortcutLegendKeyboardRenderState({
        isVisible: true,
        key: 'Escape',
        shiftKey: true,
    ...
    expect(ignoredShownEditableAltDefaultPreventedEscapeShiftRenderState.handled).toBe(false)
    expect(ignoredShownEditableAltDefaultPreventedEscapeShiftRenderState.nextVisibility).toBe(true)
    expect(ignoredShownEditableAltDefaultPreventedEscapeShiftRenderState.statusHint).toBeNull()
    expect(ignoredShownEditableAltDefaultPreventedEscapeShiftRenderState.statusAriaLabel ?? null).toBeNull()

    const ignoredShownEditableMetaRepeatEscapeShiftRenderState =
      getThreadShortcutLegendKeyboardRenderState({
        isVisible: true,
        key: 'Escape',
        shiftKey: true,
    ...
    expect(ignoredShownEditableMetaRepeatEscapeShiftRenderState.handled).toBe(false)
    expect(ignoredShownEditableMetaRepeatEscapeShiftRenderState.nextVisibility).toBe(true)
    expect(ignoredShownEditableMetaRepeatEscapeShiftRenderState.statusHint).toBeNull()
    expect(ignoredShownEditableMetaRepeatEscapeShiftRenderState.statusAriaLabel ?? null).toBeNull()

    const shownNoOpPresentation = getThreadShortcutLegendPresentation(
      ignoredShownEditableMetaRepeatEscapeShiftRenderState.nextVisibility,
    )
    expect(shownNoOpPresentation.ariaExpanded).toBe(
      ignoredShownEditableMetaRepeatEscapeShiftRenderState.nextVisibility,
    )
  ...
  it('keeps shown Esc alias with shiftKey=true non-editable modifier+event-gate paths as no-op dispatch/render-state outcomes', () => {
    const ignoredShownMetaDefaultPreventedEscAliasShiftDispatch =
      getThreadShortcutLegendKeyboardDispatchOutcome({
        isVisible: true,
        key: 'Esc',
        shiftKey: true,
    ...
    expect(ignoredShownMetaDefaultPreventedEscAliasShiftDispatch).toEqual({
      handled: false,
      nextVisibility: true,
      statusHint: null,
    })

    const ignoredShownCtrlRepeatEscAliasShiftDispatch =
      getThreadShortcutLegendKeyboardDispatchOutcome({
        isVisible: true,
        key: 'Esc',
        shiftKey: true,
    ...
    expect(ignoredShownCtrlRepeatEscAliasShiftDispatch).toEqual({
      handled: false,
      nextVisibility: true,
      statusHint: null,
    })

    const ignoredShownAltDefaultPreventedEscAliasShiftRenderState =
      getThreadShortcutLegendKeyboardRenderState({
        isVisible: true,
        key: 'Esc',
        shiftKey: true,
    ...
    expect(ignoredShownAltDefaultPreventedEscAliasShiftRenderState.handled).toBe(false)
    expect(ignoredShownAltDefaultPreventedEscAliasShiftRenderState.nextVisibility).toBe(true)
    expect(ignoredShownAltDefaultPreventedEscAliasShiftRenderState.statusHint).toBeNull()
    expect(ignoredShownAltDefaultPreventedEscAliasShiftRenderState.statusAriaLabel ?? null).toBeNull()

    const ignoredShownMetaRepeatEscAliasShiftRenderState =
      getThreadShortcutLegendKeyboardRenderState({
        isVisible: true,
        key: 'Esc',
        shiftKey: true,
    ...
    expect(ignoredShownMetaRepeatEscAliasShiftRenderState.handled).toBe(false)
    expect(ignoredShownMetaRepeatEscAliasShiftRenderState.nextVisibility).toBe(true)
    expect(ignoredShownMetaRepeatEscAliasShiftRenderState.statusHint).toBeNull()
    expect(ignoredShownMetaRepeatEscAliasShiftRenderState.statusAriaLabel ?? null).toBeNull()

    const shownNoOpPresentation = getThreadShortcutLegendPresentation(
      ignoredShownMetaRepeatEscAliasShiftRenderState.nextVisibility,
    )
    expect(shownNoOpPresentation.ariaExpanded).toBe(
      ignoredShownMetaRepeatEscAliasShiftRenderState.nextVisibility,
    )
  ...
  it('keeps shown Escape with shiftKey=true non-editable modifier+event-gate paths as no-op dispatch/render-state outcomes', () => {
    const ignoredShownMetaDefaultPreventedEscapeShiftDispatch =
      getThreadShortcutLegendKeyboardDispatchOutcome({
        isVisible: true,
        key: 'Escape',
        shiftKey: true,
    ...
    expect(ignoredShownMetaDefaultPreventedEscapeShiftDispatch).toEqual({
      handled: false,
      nextVisibility: true,
      statusHint: null,
    })

    const ignoredShownCtrlRepeatEscapeShiftDispatch =
      getThreadShortcutLegendKeyboardDispatchOutcome({
        isVisible: true,
        key: 'Escape',
        shiftKey: true,
    ...
    expect(ignoredShownCtrlRepeatEscapeShiftDispatch).toEqual({
      handled: false,
      nextVisibility: true,
      statusHint: null,
    })

    const ignoredShownAltDefaultPreventedEscapeShiftRenderState =
      getThreadShortcutLegendKeyboardRenderState({
        isVisible: true,
        key: 'Escape',
        shiftKey: true,
    ...
    expect(ignoredShownAltDefaultPreventedEscapeShiftRenderState.handled).toBe(false)
    expect(ignoredShownAltDefaultPreventedEscapeShiftRenderState.nextVisibility).toBe(true)
    expect(ignoredShownAltDefaultPreventedEscapeShiftRenderState.statusHint).toBeNull()
    expect(ignoredShownAltDefaultPreventedEscapeShiftRenderState.statusAriaLabel ?? null).toBeNull()

    const ignoredShownMetaRepeatEscapeShiftRenderState =
      getThreadShortcutLegendKeyboardRenderState({
        isVisible: true,
        key: 'Escape',
        shiftKey: true,
    ...
    expect(ignoredShownMetaRepeatEscapeShiftRenderState.handled).toBe(false)
    expect(ignoredShownMetaRepeatEscapeShiftRenderState.nextVisibility).toBe(true)
    expect(ignoredShownMetaRepeatEscapeShiftRenderState.statusHint).toBeNull()
    expect(ignoredShownMetaRepeatEscapeShiftRenderState.statusAriaLabel ?? null).toBeNull()

    const shownNoOpPresentation = getThreadShortcutLegendPresentation(
      ignoredShownMetaRepeatEscapeShiftRenderState.nextVisibility,
    )
    expect(shownNoOpPresentation.ariaExpanded).toBe(
      ignoredShownMetaRepeatEscapeShiftRenderState.nextVisibility,
    )
