...
describe('threadHintParsers', () => {
  ...
  describe('getHintShortcutSource', () => {
    ...
    it('normalizes compact aliases and symbolic shortcuts', () => {
      ...
      expect(getHintShortcutSource('Moved to previous visible thread (key: [Option+ArrowLeft]).')).toBe(
        'Option+ArrowLeft',
      )
      expect(getHintShortcutSource('Moved to next visible thread (key: [Option+ArrowRight]).')).toBe(
        'Option+ArrowRight',
      )
      expect(getHintShortcutSource('Moved to next visible thread (key: [Ctrl+ArrowDown]).')).toBe(
        'Ctrl+ArrowDown',
      )
      expect(getHintShortcutSource('Moved to previous visible thread (key: [Control+ArrowUp]).')).toBe(
        'Control+ArrowUp',
      )
      expect(getHintShortcutSource('Moved to previous visible thread (key: [Control + ArrowUp]).')).toBe(
        'Control+ArrowUp',
      ...
      expect(getHintShortcutSource('Recovered to first visible thread (Return symbol).')).toBe('Enter')
      expect(getHintShortcutSource('Recovered to first visible thread (Enter symbol).')).toBe('Enter')
      ...
      expect(getHintShortcutSource('Recovered to first visible thread (Return symbol / Enter).')).toBe(
        'Enter',
      )
      expect(getHintShortcutSource('Recovered to first visible thread (Enter / Return symbol).')).toBe(
        'Enter',
      )
      expect(getHintShortcutSource('Recovered to first visible thread (Return-key).')).toBe('Enter')
      expect(getHintShortcutSource('Recovered to first visible thread (Enter-key).')).toBe('Enter')
      expect(getHintShortcutSource('Recovered to first visible thread (NumpadEnter).')).toBe('Enter')
      expect(getHintShortcutSource('Recovered to first visible thread (Numpad Enter).')).toBe('Enter')
      expect(getHintShortcutSource('Recovered to first visible thread (Numpad Return).')).toBe('Enter')
      ...
      expect(getHintShortcutSource('Recovered to first visible thread (Return / Enter).')).toBe('Enter')
      expect(getHintShortcutSource('Recovered to first visible thread (Enter / Return).')).toBe('Enter')
      expect(getHintShortcutSource('Recovered to first visible thread (Return key / Enter key).')).toBe(
        'Enter',
      )
      expect(getHintShortcutSource('Recovered to first visible thread (Enter key / Return key).')).toBe(
        'Enter',
      )
      expect(getHintShortcutSource('Recovered to first visible thread ([Return]).')).toBe('Enter')
      ...
      expect(
        getHintShortcutSource(
          'Recovered to first visible thread (Cmd+Return symbol / Enter confirmed).',
        ),
      ).toBe('Cmd+Enter')
      expect(
        getHintShortcutSource(
      ...
      expect(getHintShortcutSource('Recovered to first visible thread (Shift Return symbol confirmed).')).toBe(
        'Shift+Enter',
      )
      expect(
        getHintShortcutSource('Recovered to first visible thread (Shift+Return symbol / Enter confirmed).'),
      ).toBe('Shift+Enter')
      expect(
        getHintShortcutSource('Recovered to first visible thread (Shift+Enter / Return symbol confirmed).'),
      ).toBe('Shift+Enter')
      expect(
        getHintShortcutSource(
          'Recovered to first visible thread (Shift+Return key / Enter symbol confirmed).',
        ),
      ).toBe('Shift+Enter')
      expect(
        getHintShortcutSource(
          'Recovered to first visible thread (Ctrl+Enter symbol / Return key confirmed).',
        ),
      ).toBe('Ctrl+Enter')
  ...
  describe('getThreadShortcutBadge', () => {
    it('maps common boundary/root shortcuts to compact badges', () => {
      ...
      expect(getThreadShortcutBadge('Control+ArrowUp')).toBe('Control+↑')
      ...
      expect(getThreadShortcutBadge('NumpadEnter')).toBe('↵')
  ...
  describe('getThreadShortcutTooltip', () => {
    it('maps shortcuts to human-readable tooltip labels', () => {
      ...
      expect(getThreadShortcutTooltip('Control+ArrowUp')).toBe('Control + Arrow Up')
      ...
      expect(getThreadShortcutTooltip('NumpadEnter')).toBe('Numpad Enter')
