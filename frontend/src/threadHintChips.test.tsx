...
describe('getShortcutChipPropsFromHint', () => {
  ...
  it('composes shortcut-legend hide status-row aria + chip rendering from uppercase escape-key mixed alias', () => {
    const legendHint = 'Thread shortcut legend hidden (ESCAPE key / Esc).'
    const legendChip = getShortcutChipPropsFromHint(legendHint, 'filter jump', 'thread-jump')
  ...
  it('composes shortcut-legend hide status-row aria + chip rendering from lowercase/mixed escape-key alias variants', () => {
    const legendHint = 'Thread shortcut legend hidden (escape key / eSC).'
    const legendChip = getShortcutChipPropsFromHint(legendHint, 'filter jump', 'thread-jump')
  ...
  it('composes shortcut-legend show status-row aria + chip rendering from uppercase slash-key and mixed-case shift+/ alias', () => {
    const legendHint = 'Thread shortcut legend shown (SLASH key / shIFT+/).'
    const legendChip = getShortcutChipPropsFromHint(legendHint, 'filter jump', 'thread-jump')
  ...
  it('composes shortcut-legend show status-row aria + chip rendering from uppercase slash-key and uppercase shift+/ alias', () => {
    const legendHint = 'Thread shortcut legend shown (SLASH key / SHIFT+/).'
    const legendChip = getShortcutChipPropsFromHint(legendHint, 'filter jump', 'thread-jump')
